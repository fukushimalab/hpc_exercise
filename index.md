...
![CPUの増加](docfig/intelcpu.png "CPUの増加" =600x)
...
![CPUとメモリの速度の変化](docfig/memorycpu.png "CPUとメモリの速度の変化" =600x)
...
![ルーフラインモデル](docfig/roofline.png "ルーフラインモデル" =600x)
