...
**レポートの必須範囲は画像処理の総合演習（導入，共通）まで**

続きは，下記から選択してレポートを書け．
* 総合演習：画像処理に相当する課題３－１～５を行う．下の”総合演習：その他”に比べて，何を実装し，どのように実験してレポートの書くのかまで指定してある．どれくらいまでのことをやる必要があるのかのガイドラインと示すために詳細を示している．
* 総合演習：その他のうちどれか一つないしはそれ以上選択し実装してレポートを書け．
