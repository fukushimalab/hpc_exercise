...
<img src="image_processing/docfig/gamma.png" width="150px">
...
![FIRフィルタ定義式](docfig/image-processing/Gaussian2DConv.png =150x)

![ガウシアンフィルタ](docfig/image-processing/Gaussian2DWeight.png =600x)

また，これを１次元畳み込みの式に分解すると以下となる．

![セパラブルガウシアンフィルタH](docfig/image-processing/Gaussian1DHConv.png =200x)

![セパラブルガウシアンフィルタV](docfig/image-processing/Gaussian1DVConv.png =200x)

![セパラブルガウシアンフィルタH重み](docfig/image-processing/Gaussian1DHWeight.png =200x)

![セパラブルガウシアンフィルタV重み](docfig/image-processing/Gaussian1DVWeight.png =200x)


イメージ図は以下の通り．

![セパラブルガウシアンフィルタ](docfig/image-processing/separable.jpg =600x)
