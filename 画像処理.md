...
![２次元畳み込み](image_processing/docfig/Gaussian2DConv.png "２次元畳み込み")

![２次元畳み込み重み](image_processing/docfig/Gaussian2DWeight.png "２次元畳み込み重み")


![１次元畳み込み重み（横）](image_processing/docfig/Gaussian1DHConv.png "１次元畳み込み（横）")

![１次元畳み込み重み（縦）](image_processing/docfig/Gaussian1DVConv.png "１次元畳み込み（縦）")

![１次元畳み込み重み（横）](image_processing/docfig/Gaussian2DWeight.png "１次元畳み込み重み（横）")

![１次元畳み込み重み（縦）](image_processing/docfig/Gaussian2DWeight.png "１次元畳み込み重み（縦）")
