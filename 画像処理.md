...
フォルダを開いてダブルクリックするか，適切なlinuxのコマンドを打てばよい．

#### チュートリアル課題
グレイの画像に対して縦横５０マスづつ黒く埋める（０を入れる）プログラムをかき，pgmで保存して画像を確認せよ．

#### チュートリアル課題
カラーで画像を読み込み緑成分だけ２倍にするプログラムを書き，pgmで保存して画像を確認せよ．
